...
/**
 * Allows the host to control banknote validator bezel illumination. Use this command to disable illumination when
 * the validator is enabled for note entry.
 */
class DisplayOff : SspCommand(SspCommandCode.DisplayOff)

suspend fun IUsbTransceiver.displayOff(): Result<SspResponse> = try {
    ...
    Result.failure(Exception("Failed execution of DisplayOff.", e))
}