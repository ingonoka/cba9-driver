...
import com.ingonoka.cba9driver.command.SspCommandCode.EventAck
 ...
 */
class EventAck : SspCommand(EventAck)

suspend fun IUsbTransceiver.eventAck(): Result<SspResponse> = try {
    ...
    Result.failure(Exception("Failed execution of acknowledging event.", e))
}